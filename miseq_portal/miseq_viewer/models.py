...
class MinIONRunSamplesheet(TimeStampedModel):
    run_id = models.OneToOneField(MinIONRun, on_delete=models.CASCADE, primary_key=True)
    sample_sheet = models.FileField(upload_to=upload_run_file, blank=True, max_length=1000)
...
class MinIONSample(TimeStampedModel):
    ...
    long_reads = models.FileField(upload_to=upload_reads, blank=True, max_length=1000)
